...
public class Welcome extends javax.swing.JFrame 
{
	...
	static String filename=null,filename1=null,testfolder="",output="",test="",out="",dbstring="",dbstring1="";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) 
    {
        ...
        output=out.replace("\\","/");     
        dbstring="jdbc:mysql://localhost:3306/";
        dbstring1="jdbc:mysql://localhost:3306/DMARC";
        try
        {         
            ...
            Connection con=DriverManager.getConnection(dbstring,"root",""); 
            java.sql.Statement stmt=con.createStatement();
            stmt.executeUpdate("Create database if not exists DMARC");
            Connection con1=DriverManager.getConnection(dbstring1, "root", "");
            Connection con2=DriverManager.getConnection(dbstring1, "root", "");
