...
public Statement stmt;  
 static String filename=null,filename1=null,testfolder="",output="",test="",out="",ip="",dbstring="",dbstring1="",u="",p="";
...
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        lblEnterIpOf = new JLabel();
        lblEnterIpOf.setToolTipText("");
        lblEnterIpOf.setText("Enter IP of Database server");
        lblEnterIpOf.setForeground(SystemColor.menu);
        lblEnterIpOf.setFont(new Font("Calibri", Font.BOLD, 24));
        
        textField = new JTextField();
        textField.setToolTipText("IP should be whitelisted");
        textField.setColumns(10);
        
        JLabel lblEnterMysqlUsername = new JLabel();
        lblEnterMysqlUsername.setToolTipText("");
        lblEnterMysqlUsername.setText("Enter MySQL username");
        lblEnterMysqlUsername.setForeground(SystemColor.menu);
        lblEnterMysqlUsername.setFont(new Font("Calibri", Font.BOLD, 24));
        
        lblEnterMysqlPassword = new JLabel();
        lblEnterMysqlPassword.setToolTipText("");
        lblEnterMysqlPassword.setText("Enter MySQL password");
        lblEnterMysqlPassword.setForeground(SystemColor.menu);
        lblEnterMysqlPassword.setFont(new Font("Calibri", Font.BOLD, 24));
        
        textField_1 = new JTextField();
        textField_1.setToolTipText("user should have all privileges");
        textField_1.setColumns(10);
        
        passwordField = new JPasswordField();
        passwordField.setToolTipText("Password should be less than 20 characters");
        	...
        	panel1Layout.createParallelGroup(Alignment.TRAILING)
        		...
        		.addGroup(panel1Layout.createSequentialGroup()
        			...
        			.addGroup(panel1Layout.createParallelGroup(Alignment.LEADING)
        				...
        				.addGroup(panel1Layout.createSequentialGroup()
        					.addComponent(button4, GroupLayout.PREFERRED_SIZE, 197, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        		...
        		.addGroup(Alignment.LEADING, panel1Layout.createSequentialGroup()
        			.addContainerGap()
        			.addComponent(lblEnterIpOf, GroupLayout.PREFERRED_SIZE, 601, GroupLayout.PREFERRED_SIZE)
        		...
        		.addGroup(Alignment.LEADING, panel1Layout.createSequentialGroup()
        			...
        			.addGroup(panel1Layout.createParallelGroup(Alignment.TRAILING, false)
        				.addGroup(Alignment.LEADING, panel1Layout.createSequentialGroup()
        					.addComponent(lblEnterMysqlPassword, GroupLayout.PREFERRED_SIZE, 601, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.UNRELATED)
        					.addComponent(passwordField))
        				.addGroup(Alignment.LEADING, panel1Layout.createSequentialGroup()
        					.addComponent(lblEnterMysqlUsername, GroupLayout.PREFERRED_SIZE, 601, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.UNRELATED)
        ...
        panel1Layout.setVerticalGroup(
        	panel1Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(panel1Layout.createSequentialGroup()
        			...
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addGroup(panel1Layout.createParallelGroup(Alignment.LEADING)
        				.addComponent(lblEnterIpOf, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
        				.addComponent(textField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addGroup(panel1Layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(lblEnterMysqlUsername, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
        				.addComponent(textField_1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addGroup(panel1Layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(lblEnterMysqlPassword, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        dbstring="jdbc:mysql://"+ip+":3306/";
        dbstring1="jdbc:mysql://"+ip+":3306/DMARC";
        u=textField_1.getText();
        p1=passwordField.getPassword();
        p=new String(p1);
        System.out.println(dbstring);
        System.out.println(dbstring1);
        try
        {         
	    ...
	    Connection con=DriverManager.getConnection(dbstring,u,p); 
	    java.sql.Statement stmt=con.createStatement();
	    stmt.executeUpdate("Create database if not exists DMARC");
	    Connection con1=DriverManager.getConnection(dbstring1, u, p);
	    Connection con2=DriverManager.getConnection(dbstring1, u, p);
    ...
    private JLabel lblEnterIpOf;
    private JTextField textField;
    private JLabel lblEnterMysqlPassword;
